...
def test_build_cv_text():
    model = CVModel(
        ...
        experiences=[Experience(title="Backend Developer", company="Tech Inc", bullets=["Built APIs", "Optimized DB"])],
        education=[Education(degree="BS", school="Uni", field="CS")],
        projects=[Project(name="App", description="A cool app", bullets=["Wrote code"])],
        skills=["Python", "Go"],
        skills_categorized={"Languages": ["Python", "Go"]},
