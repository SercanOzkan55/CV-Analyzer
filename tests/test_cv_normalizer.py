    ...
    experiences = [
        {
            ...
            "bullets": ["Email: bullet@example.com", "Phone: +0987654321", "Regular bullet point"],
        }
    ]
    cleaned = sanitize_experience_entries(experiences, data)
...
def test_guess_name():
    lines = ["Resume", "John Doe", "Software Engineer", "john@example.com"]
...
def test_ensure_name():
    data = {"header_lines": ["Resume", "Alice Bob", "Developer"], "email": "alice@example.com"}
    ensure_name(data)
...
def test_normalize_urls():
    ...
    data = {
        ...
        "nested": {"url": "https: microsoft.com", "overlong": "https://example.com/" + "a" * 600},
...
def test_strip_contact_from_education():
    ...
    data = {
        ...
        "phone": "",
        "education": [
            {"degree": "BSc in CS contact@edu.com", "school": "Stanford +123456789", "field": "CS", "location": "CA"}
        ],
    }
...
def test_strip_contact_from_all_sections():
    ...
    data = {
        ...
        "certifications": [{"name": "Cert contact@cert.com", "issuer": "Issuer +1122334455", "date": "2020"}],
    ...
    assert data["email"] in (
        "contact@proj.com",
        "contact@cert.com",
        "contact@skills.com",
        "contact@interests.com",
        "contact@langs.com",
    )
...
def test_apply_normalization_rules():
    ...
    data = {
        ...
        "phone": "",
        "experiences": [
            {"title": "Developer contact@dev.com", "company": "Tech Corp +1234567890", "bullets": ["Bullet 1"]}
        ],
        "education": [{"degree": "BSc +5556667777", "school": "Stanford"}],
    }
