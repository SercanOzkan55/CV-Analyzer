...
def calculate_final_score(cv_text: str, structured_data: Dict[str, Any], job_description: str) -> Tuple[float, float, Dict[str, Any]]:
    """
...
def _identify_weak_signals(keyword_pct: float, exp_score: float, title_match: float, seniority_match: float) -> List[str]:
