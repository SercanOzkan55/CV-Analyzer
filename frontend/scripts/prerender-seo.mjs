...
function staticEnglishPublicPage(routePath) {
  ...
  const pages = {
    '/en/about/': ['About CV Analyzer', 'CV Analyzer is an independent product designed to turn CV review into understandable findings and practical next steps rather than a single opaque score.', [
      ...
      ['Contact', 'Questions about the product, privacy or our content can be sent through the contact page or to support@cvanalyzer.dev.'],
    ]],
  ...
  const pages = {
    '/': {
      ...
      sections: [
        ...
        ['Kariyer rehberleri', 'CV hazırlama, ATS okunabilirliği, ön yazı, mülakat hazırlığı ve role özel CV örnekleri için herkese açık rehber merkezimizi ziyaret edebilirsiniz. Rehberler editoryal politikamıza göre hazırlanır ve düzenli olarak gözden geçirilir.'],
      ],
    },
    '/pricing/': {
    ...
    '/about/': {
      ...
      sections: [
        ...
        ['İletişim', 'Ürün, gizlilik veya içeriklerle ilgili sorularınızı iletişim sayfamız üzerinden veya support@cvanalyzer.dev adresine iletebilirsiniz. Yanıt sürelerimizi iletişim sayfasında bulabilirsiniz.'],
      ],
    },
  }
