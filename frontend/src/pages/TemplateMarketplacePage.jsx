      ...
      <main className="main-content template-marketplace-page" id="main-content">
        <div className="ops-header">
          <div>
            ...
            <p className="text-muted">Pick ATS-safe templates by role, seniority and use case.</p>
          </div>
        ...
        <section className="template-market-grid">
          {templates.map((item) => (
            <article className="admin-card template-market-card" key={item.id}>
              ...
              <div className="template-market-body">
                ...
                <Link className="btn-primary btn-sm" to={`/cv-builder?template=${item.id}`}>
