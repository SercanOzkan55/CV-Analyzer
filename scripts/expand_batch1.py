...
NEW = [
  # ── BAD ENGLISH (5) ──
  {"id":"B051","name":"Bad English - Backend Dev","category":"bad_english",
   ...
   "expected":{"keyword_score":{"min":25,"max":75},"ats_score":{"min":25,"max":70},"final_score":{"min":30,"max":70}}},

  {"id":"B052","name":"Bad English - Data Analyst","category":"bad_english",
   ...
   "expected":{"keyword_score":{"min":20,"max":70},"ats_score":{"min":25,"max":65},"final_score":{"min":30,"max":65}}},

  {"id":"B053","name":"Bad English - QA Engineer","category":"bad_english",
   ...
   "expected":{"keyword_score":{"min":25,"max":70},"ats_score":{"min":25,"max":65},"final_score":{"min":30,"max":70}}},

  {"id":"B054","name":"Bad English - Mobile Dev","category":"bad_english",
   ...
   "expected":{"keyword_score":{"min":30,"max":75},"ats_score":{"min":25,"max":65},"final_score":{"min":30,"max":70}}},

  {"id":"B055","name":"Bad English - DevOps","category":"bad_english",
   ...
   "expected":{"keyword_score":{"min":30,"max":80},"ats_score":{"min":25,"max":65},"final_score":{"min":35,"max":75}}},

  # ── TYPO HEAVY (5) ──
  {"id":"B056","name":"Typo Heavy - Frontend Dev","category":"typo_heavy",
   ...
   "expected":{"keyword_score":{"min":10,"max":55},"ats_score":{"min":30,"max":70},"final_score":{"min":25,"max":65}}},

  {"id":"B057","name":"Typo Heavy - Python Dev","category":"typo_heavy",
   ...
   "expected":{"keyword_score":{"min":10,"max":50},"ats_score":{"min":25,"max":65},"final_score":{"min":25,"max":65}}},

  {"id":"B058","name":"Typo Heavy - Java Dev","category":"typo_heavy",
   ...
   "expected":{"keyword_score":{"min":5,"max":45},"ats_score":{"min":25,"max":65},"final_score":{"min":25,"max":65}}},

  {"id":"B059","name":"Typo Heavy - Cloud Engineer","category":"typo_heavy",
  ...
  {"id":"B060","name":"Typo Heavy - Full Stack","category":"typo_heavy",
