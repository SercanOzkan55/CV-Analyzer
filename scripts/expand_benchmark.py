...
NEW = [
  {"id":"B011","name":"Bad English CV - Grammar Errors","category":"bad_english",
   ...
   "expected":{"keyword_score":{"min":15,"max":60},"ats_score":{"min":15,"max":50},"final_score":{"min":15,"max":55}},
   "notes":"CV full of typos/misspellings. Fuzzy matching should catch some but ATS structure very weak."},

  {"id":"B012","name":"Typo Heavy CV - Technical Terms","category":"typo_heavy",
   ...
   "expected":{"keyword_score":{"min":20,"max":65},"ats_score":{"min":40,"max":80},"final_score":{"min":30,"max":70}},
   "notes":"Technical terms misspelled. Tests fuzzy matching on common typos."},

  {"id":"B013","name":"AI-Generated CV - Verbose","category":"ai_generated",
   ...
   "expected":{"keyword_score":{"min":50,"max":90},"ats_score":{"min":55,"max":90},"final_score":{"min":55,"max":90}},
   "notes":"AI-generated verbose CV. High keyword match but buzzword-heavy content."},

  {"id":"B014","name":"Finance Analyst CV vs Finance JD","category":"finance",
   ...
   "expected":{"keyword_score":{"min":55,"max":95},"ats_score":{"min":70,"max":95},"final_score":{"min":65,"max":95}},
   "notes":"Finance domain CV vs matching Finance JD. Good keyword overlap."},

  {"id":"B015","name":"Marketing Manager vs Dev JD","category":"cross_sector",
   ...
   "expected":{"keyword_score":{"min":0,"max":15},"ats_score":{"min":45,"max":80},"final_score":{"min":25,"max":60}},
   "notes":"Complete sector mismatch. Marketing vs Backend Dev. Near-zero keyword overlap."},

  {"id":"B016","name":"Same CV Different JD - DevOps","category":"same_cv_diff_jd",
   ...
   "expected":{"keyword_score":{"min":25,"max":65},"ats_score":{"min":55,"max":85},"final_score":{"min":40,"max":80}},
   "notes":"B001 CV against DevOps JD. Partial overlap (Docker/K8s/AWS/Jenkins) but missing monitoring/IaC focus."},

  {"id":"B017","name":"Same CV Different JD - Data Science","category":"same_cv_diff_jd",
   "cv_text":"John Smith\nSenior Python Developer\n\nContact:\nEmail: john.smith@email.com\nPhone: +1 (555) 123-4567\n\nSkills:\nPython, JavaScript, SQL, Django, Flask, React, Node.js, PostgreSQL, MongoDB, Redis, AWS, Docker, Kubernetes, Terraform, Git, Jenkins, Linux\n\nExperience:\nSenior Python Developer, TechCorp, 2020 - Present\n- Led microservices architecture serving 1M+ users\n- Built ML pipelines using Python, TensorFlow, AWS\n\nEducation:\nMS Computer Science, Stanford, 2015",
   ...
   "expected":{"keyword_score":{"min":15,"max":50},"ats_score":{"min":50,"max":85},"final_score":{"min":35,"max":70}},
   "notes":"B001 CV against Data Science JD. Python/SQL/TensorFlow overlap but missing R, stats, viz tools."},

  {"id":"B018","name":"Completely Irrelevant - Chef vs Developer","category":"irrelevant",
   ...
   "expected":{"keyword_score":{"min":0,"max":10},"ats_score":{"min":40,"max":75},"final_score":{"min":20,"max":55}},
   "notes":"Zero domain overlap. Chef CV vs Python dev JD. Tests complete mismatch handling."},

  {"id":"B019","name":"German CV - Multilingual Test","category":"multilingual",
   ...
   "expected":{"keyword_score":{"min":30,"max":75},"ats_score":{"min":45,"max":80},"final_score":{"min":35,"max":75}},
   "notes":"German CV text against English JD. Technical terms should match despite language difference."},

  {"id":"B020","name":"Empty Skills Section","category":"edge_case",
   ...
   "expected":{"keyword_score":{"min":0,"max":20},"ats_score":{"min":20,"max":55},"final_score":{"min":10,"max":45}},
   "notes":"CV with empty skills section and vague experience. Very low scores expected."},

  {"id":"B021","name":"Keyword Variant - JS vs JavaScript","category":"fuzzy_test",
   ...
   "expected":{"keyword_score":{"min":20,"max":70},"ats_score":{"min":25,"max":60},"final_score":{"min":20,"max":60}},
   "notes":"Tests abbreviation matching: JS→JavaScript, TS→TypeScript, k8s→Kubernetes, Mongo→MongoDB."},

  {"id":"B022","name":"Nurse CV vs Healthcare IT JD","category":"cross_sector",
   ...
   "expected":{"keyword_score":{"min":5,"max":35},"ats_score":{"min":45,"max":80},"final_score":{"min":25,"max":60}},
   "notes":"Nurse with EHR experience vs Healthcare IT dev. Small overlap (Epic, HIPAA, EHR) but mostly mismatch."},

  {"id":"B023","name":"Intern CV - Very Short","category":"minimal",
   "cv_text":"Ali Yilmaz\nStudent\n\nEmail: ali@email.com\n\nEducation:\nComputer Engineering, ITU, 2023-2027\nGPA: 3.5\n\nSkills: Python, Java, C",
   "job_description":"Intern wanted. Python basics, willingness to learn.",
   "expected":{"keyword_score":{"min":20,"max":70},"ats_score":{"min":15,"max":50},"final_score":{"min":15,"max":55}},
   "notes":"Very short student CV for intern role. Minimal but matching content."},

  {"id":"B024","name":"Senior CV - Multiple Pages Worth","category":"long_cv",
   ...
   "expected":{"keyword_score":{"min":55,"max":95},"ats_score":{"min":75,"max":100},"final_score":{"min":70,"max":100}},
   "notes":"Very long senior CV with extensive experience. Strong match to staff engineer JD."},

  {"id":"B025","name":"Duplicate Skills Listed","category":"edge_case",
   ...
   "expected":{"keyword_score":{"min":50,"max":100},"ats_score":{"min":25,"max":60},"final_score":{"min":30,"max":65}},
   "notes":"CV with duplicate skills listed multiple times. Should not inflate keyword score beyond 100. ATS structure weak."},

  {"id":"B026","name":"Remote Work CV - Soft Skills Focus","category":"soft_skills",
  ...
  {"id":"B027","name":"Freelancer CV - No Company Names","category":"edge_case",
   ...
   "expected":{"keyword_score":{"min":45,"max":85},"ats_score":{"min":50,"max":80},"final_score":{"min":45,"max":80}},
   "notes":"Freelancer without formal company names. Good skill match but unconventional format."},

  {"id":"B028","name":"Bootcamp Grad with Projects Only","category":"entry_level",
   ...
   "expected":{"keyword_score":{"min":40,"max":80},"ats_score":{"min":45,"max":80},"final_score":{"min":40,"max":80}},
   "notes":"Bootcamp grad with projects but no work experience. JD is bootcamp-friendly."},

  {"id":"B029","name":"PhD Researcher - Too Academic","category":"academic",
  ...
  {"id":"B030","name":"Tightened Range Test - B001 Narrow","category":"tight_range",
   ...
   "expected":{"keyword_score":{"min":68,"max":82},"ats_score":{"min":82,"max":95},"final_score":{"min":82,"max":96}},
