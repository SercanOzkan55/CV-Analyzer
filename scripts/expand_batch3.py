...
NEW = [
    ...
    {
        "id": "B073",
        "name": "Finance - FinTech Developer",
        "category": "finance",
        ...
        "expected": {
            ...
            "ats_score": {"min": 45, "max": 85},
            "final_score": {"min": 45, "max": 80},
        },
    },
    {
        "id": "B074",
        "name": "Finance - Quant Analyst",
        "category": "finance",
    ...
    {
        "id": "B075",
        "name": "Finance Analyst vs Dev JD",
    ...
    {
        "id": "B076",
        "name": "Marketing - Digital Marketing Manager",
        "category": "marketing",
