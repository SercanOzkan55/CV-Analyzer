...
NEW = [
    ...
    {
        "id": "B038", "name": "Ultra Short JD", "category": "short_jd",
        ...
        "expected": {"keyword_score": {"min": 5, "max": 40}, "ats_score": {"min": 45, "max": 80}, "final_score": {"min": 25, "max": 65}},
        "notes": "Ultra short JD (1 line). System should still produce meaningful score without crashing."
    },

    # ── Very Long JD (200+ words) ──
    {
        "id": "B039", "name": "Very Long JD - Enterprise Architect", "category": "long_jd",
        ...
        "expected": {"keyword_score": {"min": 15, "max": 55}, "ats_score": {"min": 55, "max": 90}, "final_score": {"min": 40, "max": 75}},
        "notes": "Very long JD (200+ words). Tests phrase dilution cap and keyword normalization."
    },

    # ── Employment Gap ──
    {
        "id": "B040", "name": "Employment Gap - 3 Years", "category": "employment_gap",
        ...
        "expected": {"keyword_score": {"min": 10, "max": 45}, "ats_score": {"min": 40, "max": 75}, "final_score": {"min": 30, "max": 65}},
    ...
    {
        "id": "B041", "name": "Contractor - Many Short Roles", "category": "contractor",
        ...
        "expected": {"keyword_score": {"min": 30, "max": 70}, "ats_score": {"min": 50, "max": 85}, "final_score": {"min": 40, "max": 80}},
        "notes": "Contractor with many short roles. Skills match but tenure at each role is short."
    },

    # ── Non-English JD (fully Turkish JD) ──
    {
        "id": "B042", "name": "Full Turkish JD + Turkish CV", "category": "multilingual",
        ...
        "expected": {"keyword_score": {"min": 35, "max": 80}, "ats_score": {"min": 40, "max": 80}, "final_score": {"min": 40, "max": 80}},
        "notes": "Both CV and JD fully in Turkish. Technical keywords should still match."
    },

    # ── Designer applying to Dev role ──
    {
        "id": "B043", "name": "UI Designer to Frontend Dev", "category": "career_change",
        ...
        "expected": {"keyword_score": {"min": 5, "max": 30}, "ats_score": {"min": 35, "max": 75}, "final_score": {"min": 25, "max": 60}},
    ...
    {
        "id": "B044", "name": "Certification Heavy CV", "category": "certification_heavy",
        ...
        "expected": {"keyword_score": {"min": 35, "max": 75}, "ats_score": {"min": 50, "max": 85}, "final_score": {"min": 45, "max": 80}},
    ...
    {
        "id": "B045", "name": "Student - Projects Only", "category": "entry_level",
    ...
    # ── Management role mismatch ──
    {
        ...
        "expected": {"keyword_score": {"min": 10, "max": 40}, "ats_score": {"min": 45, "max": 80}, "final_score": {"min": 30, "max": 65}},
        "notes": "Manager applying for IC role. Python/Django overlap but missing hands-on tech stack."
    },

    # ── Same industry different role ──
    {
        "id": "B048", "name": "Backend Dev vs Frontend JD", "category": "role_mismatch",
        ...
        "expected": {"keyword_score": {"min": 0, "max": 20}, "ats_score": {"min": 45, "max": 80}, "final_score": {"min": 25, "max": 60}},
    ...
    {
        "id": "B049", "name": "Portfolio-Heavy CV", "category": "portfolio",
        ...
        "expected": {"keyword_score": {"min": 40, "max": 85}, "ats_score": {"min": 55, "max": 90}, "final_score": {"min": 50, "max": 85}},
        "notes": "Strong portfolio and open source. High keyword match with JD."
    },

    # ── Duplicate/repeated content in CV ──
    {
        "id": "B050", "name": "Repetitive CV Content", "category": "edge_case",
        ...
        "expected": {"keyword_score": {"min": 20, "max": 65}, "ats_score": {"min": 30, "max": 70}, "final_score": {"min": 25, "max": 65}},
