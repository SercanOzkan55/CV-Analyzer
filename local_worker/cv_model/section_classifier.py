...
from .section_scorer import score_text as _scorer_score_text
from .section_aliases import _CANONICAL_KEYS, _FUZZY_FRAGMENTS, _GLOBAL_ALIASES
...
# Regex + header-hint patterns live in services/section_patterns.py (imported above).
# ── block splitter ────────────────────────────────────────────────────────
...
# Canonical keys + alias maps live in services/section_aliases.py (imported above).
