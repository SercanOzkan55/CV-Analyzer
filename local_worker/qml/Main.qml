                ...
                ScrollView {
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            ColumnLayout {
                                ...
                                GlassCard {
                                    ...
                                    Rectangle {
                                        id: dashboardDropZone
                                        anchors.fill: parent
                                        anchors.margins: 18
                                        radius: 18
                                        color: root.themeInput
                                        border.width: 1
                                        border.color: dashboardDropArea.containsDrag ? root.themePrimary : root.themeBorder

                                        DropArea {
                                            id: dashboardDropArea
                                            anchors.fill: parent
                                            onDropped: function(drop) {
                                                if (drop.hasUrls && drop.urls.length > 0) {
                                                    backend.setCvFolderFromUrl(drop.urls[0])
                                                    drop.accept()
                                                }
                                            }
                                        }
                                        ...
                                        ColumnLayout {
                                            ...
                                            Text {
                                                Layout.alignment: Qt.AlignHCenter
                                                text: "Drop your CV folder here or click to browse"
                                                color: root.themeText
                                                font.pixelSize: 14
                                                font.weight: Font.Bold
                                                horizontalAlignment: Text.AlignHCenter
                                            ...
                                            Text {
                                                Layout.fillWidth: true
                                                text: "Supports PDF, DOCX, TXT. Analysis stays on this device."
                                                color: root.themeText2
                                                font.pixelSize: 11
                                                horizontalAlignment: Text.AlignHCenter
                                                wrapMode: Text.WordWrap
                                            ...
                                            Text {
                                                Layout.fillWidth: true
                                                text: backend.cvFolder || "No folder selected yet"
                                                color: backend.cvFolder ? root.themeText2 : root.themeMuted
                                                font.pixelSize: 10
                                                horizontalAlignment: Text.AlignHCenter
                                                elide: Text.ElideMiddle
                                            }
                            ...
                            GlassCard {
                                ...
                                ColumnLayout {
                                    ...
                                    ScoreRing {
                                        Layout.alignment: Qt.AlignHCenter
                                        value: backend.averageScoreValue > 0 ? backend.averageScoreValue : 0
                                        ringColor: root.themeSuccess
                                    }

                                    Text {
                                        Layout.alignment: Qt.AlignHCenter
                                        text: backend.averageScoreValue > 0 ? (backend.averageScoreValue >= backend.acceptThreshold ? "Excellent Match" : "Ready to review") : "No score yet"
                                        color: backend.averageScoreValue > 0 ? root.themeSuccess : root.themeText2
                                        font.pixelSize: 12
                                        font.weight: Font.Bold
                                    }
                                    ...
                                    AppButton {
                                        ...
                                        text: "Top " + Math.max(1, backend.shortlistedCount)
                                        fill: "#113225"
                                        fillHover: "#16402e"
                                        stroke: "#22654b"
                                        textColor: "#b8f7dd"
                            ...
                            GlassCard {
                                ...
                                ColumnLayout {
                                    ...
                                    ActivityItem {
                                        title: backend.isRunning ? "Analysis running" : "Workspace ready"
                                        detail: backend.status
                                        time: "now"
                                        accent: backend.isRunning ? "#ffb84d" : "#2ee59d"
                                    }
                                    ActivityItem {
                                        title: "CV folder"
                                        detail: backend.cvFolder ? backend.cvFolder : "Waiting for local source"
                                        time: "local"
                                        accent: "#35a7ff"
                                    }
                                    ActivityItem {
                                        title: "Reports"
                                        detail: "CSV, JSON and HTML exports available"
                                        time: "ready"
                                        accent: "#9a6cff"
                                    }
                                    ActivityItem {
                                        title: "Templates"
                                        detail: "Accept and reject emails stay local"
                                        time: "local"
                                        accent: "#ffb84d"
                                    }
                        ...
                        RowLayout {
                            Layout.fillWidth: true
                            spacing: 12
                            MetricCard { label: "Total Analyses"; value: backend.historyRunCount; detail: "Saved local runs"; accent: root.themePrimary; surface: root.themeCard; stroke: root.themeBorder; primaryText: root.themeText; mutedText: root.themeText2; subtleText: root.themeMuted }
                            MetricCard { label: "Candidate Pool"; value: backend.totalCandidates; detail: backend.isRunning ? "Running now" : "Current run"; accent: root.themeSecondary; surface: root.themeCard; stroke: root.themeBorder; primaryText: root.themeText; mutedText: root.themeText2; subtleText: root.themeMuted }
                            MetricCard { label: "Avg. Score"; value: backend.averageScoreValue > 0 ? backend.averageScore : "-"; detail: "Match quality"; accent: root.themeSecondary; surface: root.themeCard; stroke: root.themeBorder; primaryText: root.themeText; mutedText: root.themeText2; subtleText: root.themeMuted }
                            MetricCard { label: "Shortlisted"; value: backend.shortlistedCount; detail: "Top candidates"; accent: root.themeSuccess; surface: root.themeCard; stroke: root.themeBorder; primaryText: root.themeText; mutedText: root.themeText2; subtleText: root.themeMuted }
                        }

                        RowLayout {
                            Layout.fillWidth: true
                            Layout.preferredHeight: 196
                            visible: backend.isRunning || backend.totalCandidates > 0
                            spacing: 14
                                ...
                                ColumnLayout {
                                    ...
                                    RowLayout {
                                        ...
                                        Pill {
                                            ...
                                            tint: backend.pipelineStep >= 4 ? "#2ee59d" : "#7c5cff"
                                        }
                                    }
                                    ...
                                    RowLayout {
                                        ...
                                        PipelineStep {
                                            Layout.fillWidth: true
                                            title: "Source"
                                            detail: "Local CV folder"
                                            number: 1
                                            complete: backend.pipelineStep > 1 || backend.totalCandidates > 0
                                            active: backend.pipelineStep === 1
                                        }
                                        PipelineStep {
                                            Layout.fillWidth: true
                                            title: "Extract"
                                            detail: "PDF, DOCX, TXT text"
                                            number: 2
                                            complete: backend.pipelineStep > 2 || backend.totalCandidates > 0
                                            active: backend.pipelineStep === 2
                                        }
                                        PipelineStep {
                                            Layout.fillWidth: true
                                            title: "Score"
                                            detail: "Skill matching"
                                            number: 3
                                            complete: backend.pipelineStep > 3 || backend.totalCandidates > 0
                                            active: backend.pipelineStep === 3
                                        }
                                        PipelineStep {
                                            Layout.fillWidth: true
                                            title: "Export"
                                            detail: "CSV, JSON, HTML"
                                            number: 4
                                            complete: backend.pipelineStep >= 4
                                            active: backend.pipelineStep === 4
                                        }
                                    }
                                }
                            }
                            ...
                            GlassCard {
                                ...
                                ColumnLayout {
                                    ...
                                    DistributionBar { label: "Top matches"; count: backend.topScoreCount; accent: "#2ee59d" }
                                    DistributionBar { label: "Needs review"; count: backend.reviewScoreCount; accent: "#ffb84d" }
                                    DistributionBar { label: "Low fit"; count: backend.lowScoreCount; accent: "#ff4d6d" }

                                    Text {
                                        Layout.fillWidth: true
                                        text: backend.duplicateCount > 0 ? backend.duplicateCount + " duplicate CV detected" : "No duplicate CVs detected"
                                        color: root.themeText2
                                        font.pixelSize: 11
                                    }
                                }
                        ...
                        GridLayout {
                            ...
                            GlassCard {
                                ...
                                ColumnLayout {
                                    ...
                                    ScoreBar { label: "Required skills"; value: backend.averageScoreValue > 0 ? Math.min(100, backend.averageScoreValue + 6) : 92; accent: "#2ee59d" }
                                    ScoreBar { label: "Experience"; value: backend.averageScoreValue > 0 ? Math.max(0, backend.averageScoreValue - 2) : 85; accent: "#35a7ff" }
                                    ScoreBar { label: "Education"; value: backend.averageScoreValue > 0 ? Math.max(0, backend.averageScoreValue - 9) : 78; accent: "#9a6cff" }
                                    ScoreBar { label: "Soft skills"; value: backend.averageScoreValue > 0 ? Math.max(0, backend.averageScoreValue - 1) : 88; accent: "#ffb84d" }
                                    ScoreBar { label: "Overall fit"; value: backend.averageScoreValue > 0 ? backend.averageScoreValue : 87; accent: "#28e0e6" }
                                }
                            }
                            ...
                            GlassCard {
                                ...
                                ColumnLayout {
                                    ...
                                    Pill { text: "AI INSIGHTS"; tint: "#9a6cff" }

                                    Text {
                                        Layout.fillWidth: true
                                        text: backend.totalCandidates > 0 ? "Your local batch is ready for review." : "Prepare a local batch to unlock recommendations."
                                        color: root.themeText
                                        font.pixelSize: 14
                                        font.weight: Font.Bold
                                        wrapMode: Text.WordWrap
                                    ...
                                    Text {
                                        Layout.fillWidth: true
                                        text: "Focus on matched skills, missing requirements, and risk flags before exporting shareable reports."
                                        color: root.themeText2
                                        font.pixelSize: 12
                                        wrapMode: Text.WordWrap
                                        lineHeight: 1.2
                                    ...
                                    AppButton {
                                        ...
                                        strong: true
                                        onClicked: root.pageIndex = backend.totalCandidates > 0 ? 2 : 1
                                    }
                                }
                            }
                        }
                        ...
                        GlassCard {
                            ...
                            ColumnLayout {
                                ...
                                ListView {
                                    ...
                                    delegate: Rectangle {
                                        id: candidateRow
                                        property bool selected: backend.selectedIndex === index

                                        width: ListView.view.width
                                        height: 112
                                        radius: 18
                                        color: selected ? "#121a2d" : (candidateMouse.containsMouse ? "#101827" : "#0b1322")
                                        border.width: 1
                                        border.color: selected ? "#7c5cff" : (candidateMouse.containsMouse ? "#3d4b72" : "#253856")
                                        scale: candidateMouse.containsMouse ? 1.008 : 1
                                        ...
                                        MouseArea {
                                            ...
                                            onClicked: backend.selectResult(index)
                                        }
                                        ...
                                        RowLayout {
                                            ...
                                            ColumnLayout {
                                                ...
                                                Text {
                                                    Layout.fillWidth: true
                                                    text: matchedSkills || "No matched skills"
                                                    color: root.themeText2
                                                    font.pixelSize: 12
                                                    elide: Text.ElideRight
                                                }
                        ...
                        GlassCard {
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    ...
                                    AppButton {
                                        text: "Mail"
                                        enabled: backend.selectedIndex >= 0
                                        onClicked: root.pageIndex = 6
                                    }
                                }
                                ...
                                EmptyState {
                                    ...
                                    detail: "Run or load a local analysis, then choose a candidate from the list to inspect score, risks, skills, and sync state."
                                    actionText: backend.totalCandidates === 0 ? "Start analysis" : ""
                                    targetPage: 1
                                }
                                ...
                                Rectangle {
                                    ...
                                    RowLayout {
                                        ...
                                        ColumnLayout {
                                            ...
                                            RowLayout {
                                                spacing: 8
                                                Pill { text: backend.selectedDecisionLabel; tint: "#8b5cf6" }
                                                Pill { text: backend.selectedSyncStatus; tint: "#2ee59d" }
                                            }
                                        }
                                    }
                                }
                                ...
                                RowLayout {
                                    ...
                                    MetricCard {
                                        label: "Confidence"
                                        value: backend.selectedConfidence
                                        detail: "Model certainty"
                                        accent: "#35a7ff"
                                    }
                                    MetricCard {
                                        label: "Duplicate"
                                        value: backend.selectedDuplicateStatus
                                        detail: "Hash check"
                                        accent: backend.selectedDuplicateStatus === "Duplicate" ? "#ffb84d" : "#2ee59d"
                                    }
                                }
                                ...
                                RowLayout {
                                    ...
                                    AppButton {
                                        ...
                                        stroke: "#22654b"
                                        textColor: "#b8f7dd"
                                        onClicked: backend.setSelectedDecision("recommended_accept")
                                    }
                                    AppButton {
                                        Layout.fillWidth: true
                                        text: "Review"
                                        ...
                                        stroke: "#765c26"
                                        textColor: "#ffe2a8"
                                        onClicked: backend.setSelectedDecision("recommended_review")
                                    }
                                    AppButton {
                                        Layout.fillWidth: true
                                        text: "Reject"
                                        ...
                                        stroke: "#763044"
                                        textColor: "#ffbdca"
                                        onClicked: backend.setSelectedDecision("recommended_reject")
                                    }
                                }

                                FieldLabel { text: "LOCAL FILE"; visible: backend.selectedIndex >= 0 }
                                Text {
                                    Layout.fillWidth: true
                                    visible: backend.selectedIndex >= 0
                                    text: backend.selectedFilePath || "No file selected"
                                    color: root.themeText2
                                    wrapMode: Text.WordWrap
                                    font.pixelSize: 11
                                    maximumLineCount: 2
                                ...
                                FieldLabel { text: "SUMMARY"; visible: backend.selectedIndex >= 0 }
                                Text {
                                    Layout.fillWidth: true
                                    visible: backend.selectedIndex >= 0
                                ...
                                FieldLabel { text: "MATCHED SKILLS"; visible: backend.selectedIndex >= 0 }
                                Text {
                                    Layout.fillWidth: true
                                    visible: backend.selectedIndex >= 0
                                    text: backend.selectedMatchedSkills
                                    color: "#38d39f"
                                    wrapMode: Text.WordWrap
                                    font.pixelSize: 13
                                }

                                FieldLabel { text: "MISSING SKILLS"; visible: backend.selectedIndex >= 0 }
                                Text {
                                    Layout.fillWidth: true
                                    visible: backend.selectedIndex >= 0
                                    text: backend.selectedMissingSkills
                                    color: root.themeWarning
                                    wrapMode: Text.WordWrap
                                    font.pixelSize: 13
                                }

                                FieldLabel { text: "EXPLANATION"; visible: backend.selectedIndex >= 0 }
                                Text {
                                    Layout.fillWidth: true
                                    Layout.fillHeight: true
                                    visible: backend.selectedIndex >= 0
                                ...
                                FieldLabel { text: "RISK FLAGS"; visible: backend.selectedIndex >= 0 }
                                Text {
                                    Layout.fillWidth: true
                                    visible: backend.selectedIndex >= 0
                                    text: backend.selectedRiskFlags
                                    color: "#ffbdca"
                                    wrapMode: Text.WordWrap
                                    font.pixelSize: 13
                                }
