...
<!--
  GitHub render edilen markdown'da JavaScript ve <style>/<input> calistirmaz
  (guvenlik icin ayiklanir), bu yuzden gercek "tek tikla aninda degisen"
  sekme mumkun degil. En yakini <details>/<summary>: sayfa yenilenmeden,
  ayni belgede acilip kapanir. Asagidaki rozetler yalnizca gorsel — TR
  varsayilan acik, EN kapali; her ikisi de istenirse ayni anda acik kalabilir.
-->

<details open>
<summary>

![Türkçe](https://img.shields.io/badge/🇹🇷_TÜRKÇE-0969DA?style=for-the-badge)&nbsp;&nbsp;<sub>(açık — başlığa tıkla, kapat/aç)</sub>
...
![English](https://img.shields.io/badge/🇬🇧_ENGLISH-30363D?style=for-the-badge)&nbsp;&nbsp;<sub>(click the heading to expand)</sub>
